...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consulte el el pais del atleta deseado");
	...
	// ************************************************************************
	// Ejecuta la opcion de consultar el pais de un atleta. 
	// ************************************************************************
	
	private void ejecutarPaisAltleta()
	{ 
		System.out.println("\n" + "Pais al cual pertenece el atleta de su interes"); 
		String atleta = input("Ingrese el atleta que desea buscar");
		String PaisAtleta = calculadora.BuscarAtletaPais(atleta);
		
		if (PaisAtleta == null)
			
		{
			System.out.println("\n" + "El atleta que busca no existe!"); 
		}
		
		else if(PaisAtleta != null)
			
		{
			System.out.println("\n" + "El atleta busca proviene del pais " + PaisAtleta); 
		}
